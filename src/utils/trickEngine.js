...
exports.designateLeadSuit = designateLeadSuit;
exports.hasCardsOfSuit = hasCardsOfSuit;
exports.validateSuitFollowing = validateSuitFollowing;
exports.determineTrickWinner = determineTrickWinner;
exports.isVoidInSuit = isVoidInSuit;
exports.getValidJhabbuCards = getValidJhabbuCards;
exports.validateJhabbu = validateJhabbu;
/**
 ...
 */
function designateLeadSuit(firstCard) {
 ...
 */
function hasCardsOfSuit(hand, suit) {
 ...
 */
function validateSuitFollowing(cardToPlay, hand, leadSuit) {
 ...
 */
function isVoidInSuit(hand, leadSuit) {
 ...
 */
function getLowestCardOfSuit(hand, suit) {
    const cardsOfSuit = hand.filter(card => card.suit === suit);
    if (cardsOfSuit.length === 0) {
        return null;
    }
    return cardsOfSuit.reduce((lowest, current) => getRankValue(current.rank) < getRankValue(lowest.rank) ? current : lowest);
}
/**
 ...
 */
function getValidJhabbuCards(hand, leadSuit, chosenSuit) {
 ...
 */
function validateJhabbu(cardsToPlay, hand, leadSuit) {
...
//# sourceMappingURL=trickEngine.js.map