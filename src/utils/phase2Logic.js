...
exports.handlePhase2CardPlay = handlePhase2CardPlay;
exports.checkPlayerElimination = checkPlayerElimination;
exports.handlePhase2TrickWithElimination = handlePhase2TrickWithElimination;
exports.transitionToPhase2 = transitionToPhase2;
const trickEngine_1 = require("./trickEngine");
/**
 ...
 */
function handlePhase2CardPlay(playerId, cards, players, trickCards, currentLeadSuit, expectedPlayerId) {
    ...
    const allCardsInHand = cards.every(card => player.hand.some(c => c.id === card.id));
    if (!allCardsInHand) {
        return {
            success: false,
    ...
    if (trickCards.length === 0) {
        ...
        leadSuit = (0, trickEngine_1.designateLeadSuit)(cards[0]);
    }
    else {
    ...
    if (cards.length === 1) {
        ...
        if (!(0, trickEngine_1.validateSuitFollowing)(cards[0], player.hand, leadSuit)) {
        ...
        if (!(0, trickEngine_1.validateJhabbu)(cards, player.hand, leadSuit)) {
    ...
    const trickWinnerId = (0, trickEngine_1.determineTrickWinner)(updatedTrickCards, leadSuit);
 ...
 */
function checkPlayerElimination(players) {
 ...
 */
function handlePhase2TrickWithElimination(playerId, cards, players, trickCards, currentLeadSuit, expectedPlayerId) {
    // Handle the round play
    const playResult = handlePhase2CardPlay(playerId, cards, players, trickCards, currentLeadSuit, expectedPlayerId);
    ...
    if (eliminationResult.eliminatedPlayerIds.length > 0) {
        console.log('Phase 2 Player Elimination:', {
            eliminatedPlayers: eliminationResult.eliminatedPlayerIds.map(id => playResult.updatedPlayers.find(p => p.id === id)?.name),
 ...
 */
function transitionToPhase2(players) {
...
//# sourceMappingURL=phase2Logic.js.map