...
exports.hasDuplicateRank = hasDuplicateRank;
exports.findSubsetSum = findSubsetSum;
exports.getLongestCombination = getLongestCombination;
 ...
 */
function hasDuplicateRank(playedCard, tableCards) {
 ...
 */
function getLongestCombination(combinations) {
    if (combinations.length === 0) {
        return [];
    }
    return combinations.reduce((longest, current) => current.length > longest.length ? current : longest);
}
/**
 ...
 */
function checkPenalty(playedCard, tableCards) {
    let duplicateRankPenalty = null;
    let sumPenalty = null;
