...
exports.transitionToLobby = transitionToLobby;
exports.transitionToDealing = transitionToDealing;
exports.transitionToBeriz = transitionToBeriz;
exports.transitionToJhabbu = transitionToJhabbu;
exports.transitionToGameOver = transitionToGameOver;
exports.transitionToPhase = transitionToPhase;
/**
 ...
 */
function isValidTransition(currentPhase, targetPhase) {
 ...
 */
function transitionToLobby(gameState) {
 ...
 */
function transitionToDealing(gameState) {
 ...
 */
function transitionToBeriz(gameState) {
 ...
 */
function transitionToJhabbu(gameState) {
 ...
 */
function transitionToGameOver(gameState) {
    ...
    const playersWithCards = gameState.players.filter(player => player.hand.length > 0);
    if (playersWithCards.length !== 1) {
        throw new Error(`Cannot transition to GAME_OVER: expected 1 player with cards, found ${playersWithCards.length}`);
    }
 ...
 */
function transitionToPhase(gameState, targetPhase) {
    switch (targetPhase) {
        case 'LOBBY':
